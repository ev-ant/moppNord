article_mopp <- function(toc = TRUE,
                         toc_depth = 4,
                         ...
                         df_print = "default",
                         highlight = "default",
                         template = paste0(find.package("moppNord")[1], "/rmarkdown/rmd/article.tex"),
                         keep_tex = FALSE,
                         keep_md = FALSE,
 ...
 # args <- c(args, pandoc_highlight_args(highlight))
  ...
  output_format(
    ...
    pandoc = pandoc_options(
      ...
      keep_tex = keep_tex,
      lua_filters = c(pkg_file_lua(c("pagebreak.lua", "latex-div.lua"), paste0(find.package("moppNord")[1],"rmarkdown/lua/multiple-bibliographies.lua"))
    ),
